  ...
  return (
    <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="space-y-6">
        <p>
          These Terms of Service govern your use of the WikiClub Tech website.
          By using our website, you agree to these terms.
        </p>
        <h2 className="text-2xl font-bold">1. Use of Our Website</h2>
        <p>
          You may use our website only for lawful purposes and in accordance
          with these Terms of Service. You agree not to use our website:
        </p>
        <ul className="list-disc list-inside space-y-2">
          ...
          <li>
            ...
            Tech employee, another user, or any other person or entity.
          </li>
        </ul>
        ...
        <p>
          ...
          arrangement thereof) are owned by WikiClub Tech, its licensors, or
